    ...
    if ($count == 1) {
        ...
        if (is_array($statement)) {
            ...
            if (password_verify($password, $statement['password'])) {
                ...
                header("location:visitorLand.php?id=".$statement['id']);
                die;
            } else {
                ?>
                <div class="alert-box">
    ...
    if (isset($_POST["login"])) {
        ...
        */
        if (!empty($_POST['email'])) {
            ...
            $query = "SELECT * FROM visitor WHERE email = :email LIMIT 1";
           ...
           connect($statement,$password);
            ...
            $password = $_POST['password'];
            $query = "SELECT * FROM visitor WHERE phoneNumber = :phoneNumber LIMIT 1";
            $statement = $pdo->prepare($query);
        ...
        <form method="POST">
            ...
            <a>
                ...
                <input type="submit" name="login" value="LOGIN" style="font-family: Phantomsans, sans-serif; background-color:transparent;
                 ...
                 <a href="visitorRegister.php" style=" float:right;font-family: Phantomsans, sans-serif;"> Don't have an account? Register</a>
            </a>
